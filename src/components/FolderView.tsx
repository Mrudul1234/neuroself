...
export function FolderView({ items, onChanged }: Props) {
  return (
    ...
    <div className="w-full rounded-[24px] p-3.5 sm:p-[16px] bg-gradient-to-br from-[#6b4c35] via-[#4d3220] to-[#3a2212] shadow-[0_16px_36px_rgba(0,0,0,0.45),inset_0_2px_4px_rgba(255,255,255,0.18)] relative overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          `,
          backgroundSize:
            "16px 16px, 20px 20px, 24px 24px, 18px 18px, 28px 28px, 22px 22px, 14px 14px",
